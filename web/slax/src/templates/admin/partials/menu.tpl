<nav id="menu" class="hidden-md hidden-lg">
	...
	<section class="menu-section">
		...
		<ul class="menu-section-list">
			...
			<li><a href="{relative_path}/admin/manage/comment-queue">[[admin/menu:manage/comment-queue]]</a></li>
	...
	<section class="menu-section">
		...
		<ul class="menu-section-list">
			...
			<li><a href="{relative_path}/admin/settings/comment">[[admin/menu:settings/comment]]</a></li>
	...
	<section class="menu-section">
		...
		<ul class="menu-section-list">
			...
			<li><a href="{relative_path}/admin/extend/widgets/category">[[admin/menu:extend/widgets/category]]</a></li>
