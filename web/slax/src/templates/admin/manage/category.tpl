		...
		<div class="col-md-9" id="category-settings">
			<div class="category-settings-form">
				<fieldset>
					...
					<label for="cid-{category.cid}-topicType">
						[[admin/manage/categories:topic-type]]
					</label>
					<input id="cid-{category.cid}-topicType" data-name="topicType" placeholder="[[admin/manage/categories:topic-type]]" value="{category.topicType}" class="form-control category_topicType topicType" /><br />

					<label for="cid-{category.cid}-topicListViewType">
						[[admin/manage/categories:topiclist-viewtype]]
					</label>
					<input id="cid-{category.cid}-topicListViewType" data-name="topicListViewType" placeholder="[[admin/manage/categories:topiclist-viewtype]]" value="{category.topicListViewType}" class="form-control category_topicListViewType topicListViewType" /><br />

					<label for="cid-{category.cid}-subcategoryListViewType">
						[[admin/manage/categories:subcategorylist-viewtype]]
					</label>
					<input id="cid-{category.cid}-subcategoryListViewType" data-name="subcategoryListViewType" placeholder="[[admin/manage/categories:subcategorylist-viewtype]]" value="{category.subcategoryListViewType}" class="form-control category_subcategoryListViewType subcategoryListViewType" /><br />

					<div class="form-group">
						<div class="checkbox">
							<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
								<input type="checkbox" class="mdl-switch__input" id="cid-{category.cid}-topicsListAllDescendants" data-name="topicsListAllDescendants" <!-- IF category.topicsListAllDescendants -->checked<!-- ENDIF category.topicsListAllDescendants --> />
								<span class="mdl-switch__label"><strong>list all topics on current category and descendant cacategories</strong></span>
							</label>
						</div>
					</div>
				</fieldset>
				...
				<fieldset class="row">
					<div class="col-sm-6 col-xs-12">
						<div class="form-group">
							<div class="checkbox">
								<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
									<input type="checkbox" class="mdl-switch__input" id="cid-{category.cid}-isDivision" data-isDivision="isSection" <!-- IF category.isDivision -->checked<!-- ENDIF category.isDivision --> />
									<span class="mdl-switch__label"><strong>[[admin/manage/categories:is-division]]</strong></span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="form-group col-sm-6 col-xs-12">
						...
						<label for="cid-{category.cid}-division-route">
							[[admin/manage/categories:division-route]]
						</label>
						<input id="cid-{category.cid}-division-route" type="text" class="form-control" placeholder="route path" data-name="divisionRoute" value="{category.divisionRoute}" />
					</div>				
				...
				<fieldset>
					<div class="form-group">
						<div class="checkbox">
							<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
								<input type="checkbox" class="mdl-switch__input" id="cid-{category.cid}-noInheritTemplate" data-name="noInheritTemplate" <!-- IF category.noInheritTemplate -->checked<!-- ENDIF category.noInheritTemplate --> />
								<span class="mdl-switch__label"><strong>do not inherit template from  parent category</strong></span>
							</label>
						</div>
					</div>
					<div class="form-group">
						<label>Topics List Templater:</label>
						<textarea id="topic-list-templater" rows="4" class="form-control list-template" data-name="topicListTemplater" placeholder="The Category topic List template.">{category.topicListTemplater}</textarea>
					</div>				
					<div class="form-group">
						<label>SubCategory List Templater:</label>
						<textarea id="subcategory-list-templater" rows="4" class="form-control list-template" data-name="subcategoryListTemplater" placeholder="The Category topic List template.">{category.subcategoryListTemplater}</textarea>
					</div>				
				</fieldset>
				<fieldset>
