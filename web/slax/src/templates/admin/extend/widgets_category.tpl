...
<div class="lead row">
	[[admin/extend/widgets:category-selector]]
			...
			<div class="panel-body">
				...
				<div class="available-containers">
					<div class="containers">
						...
						<div class="panel" data-container-html='<div class="panel panel-default widget widget-\{{type}}"><div class="panel-body">\{{body}}</div></div>'>
							<div class="panel-body pointer">
								[[admin/extend/widgets:container.panel]]
							</div>
						</div>
						<div class="panel panel-default pointer" data-container-html='<div class="panel panel-default widget widget-\{{type}}"><div class="panel-heading"><h3 class="panel-title">\{{title}}</h3></div><div class="panel-body">\{{body}}</div></div>'>
							<div class="panel-heading">
