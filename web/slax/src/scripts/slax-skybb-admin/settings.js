			...
			saveFields(fields, function onFieldsSaved(err) {
				if (err) {
					return app.alert({
						...
						message: 'SkyBB encountered a problem saving your changes. (' + err.message + ')',
						type: 'danger',
					});
				}
				...
				app.alert({
					...
					timeout: 2500,
					title: 'Changes Saved',
					message: 'Your changes to the SkyBB configuration have been saved.',
					type: 'success',
				});
