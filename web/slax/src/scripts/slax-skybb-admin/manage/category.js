...
define([
	...
	'slax-skybb-base/misc/uploader',
	'slax-skybb-base/misc/iconSelect',
	'../modules/colorpicker',
	'slax-skybb-base/misc/autocomplete',
	"slax-skybb-base/misc/translator",
	'slax-skybb-base/topics/categorySelector',
	"skylark-benchpress",
], function ($, socket, uploader, iconSelect, colorpicker, autocomplete, translator, categorySelector, Benchpress) {
	var	Category = {};
	...
	Category.init = function () {
		...
		$('#category-settings input, #category-settings select, #category-settings textarea').on('change', function (ev) { // modified by lwf
			modified(ev.target);
		});
