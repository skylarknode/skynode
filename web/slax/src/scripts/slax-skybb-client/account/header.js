define( [
	...
	'slax-skybb-base/misc/coverPhoto',
	'slax-skybb-base/misc/pictureCropper',
	'slax-skybb-base/misc/components',
	"slax-skybb-base/misc/translator",
	"slax-skybb-base/misc/flags"
], function ($, Benchpress, socket, coverPhoto, pictureCropper, components, translator,flags) {
	'use strict';
	var AccountHeader = {};
		...
		coverPhoto.init(
			...
			function () {
				pictureCropper.show({
					...
					imageUrlOnServer = (!imageUrlOnServer.startsWith('http') ? app.assetsBaseUrl : '') + imageUrlOnServer + '?' + Date.now();
