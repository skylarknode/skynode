define([
	...
	'./topicSelect', 
	'./topicList'
], function ($,socket, utils,components,topicSelect,  topicList) {
	'use strict';
	var Unread = {};
	...
	function updateUnreadTopicCount(url, count) {
		...
		$('a[href="' + app.pageBasePath + url + '"].navigation-link i')
	...
	Unread.initUnreadTopics = function () {
		...
		function increaseUnreadCount(filter) {
			...
			var newCount = 1 + parseInt($('a[href="' + app.pageBasePath + unreadUrl + '"].navigation-link i').attr('data-content'), 10);
