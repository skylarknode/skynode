define([
	...
	Posts.onNewPostPagination = function onNewPostPagination(data) {
	...
	function updatePagination() {
		...
		$.get(app.apiBaseUrl + '/api/topic/pagination/' + ajaxify.data.tid, { page: ajaxify.data.pagination.currentPage }, function (paginationData) {
	...
	Posts.onNewPostInfiniteScroll = function onNewPostInfiniteScroll(data) {
		var direction = config.topicPostSort === 'oldest_to_newest' || config.topicPostSort === 'most_votes' ? 1 : -1;
