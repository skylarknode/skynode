define([
	...
	"./sounds",
	"../utils"
], function ($,Wordpad,socket,components, taskbar,sounds, utils) {
	'use strict';
	...
	function wordpadify(textarea, data) {
	    ...
	    options.toolbar =  ["bold", "underline", "strikethrough", "color", 'mark',"ul", "ol"];
	...
	module.createModal = function (data, callback) {
		require(['scrollStop', 'forum/chats', 'forum/chats/messages'], function (scrollStop, Chats, ChatsMessages) {
			app.parseAndTranslate('chat', data, function (chatModal) {
				...
				//app.loadJQueryUI(function () { // modified by lwf
