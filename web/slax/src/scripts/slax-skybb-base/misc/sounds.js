define([
	...
	function loadData(callback) {
		...
		if (fileMap) {
			...
			$.getJSON(app.assetsBaseUrl + '/assets/sounds/fileMap.json', function (map) {
				fileMap = map;
				after();
			});
		}
	...
	Sounds.playSound = function playSound(soundName) {
		...
		function after() {
			...
			var audio = cache[soundName] || new Audio(app.assetsBaseUrl + '/assets/sounds/' + fileMap[soundName]);
