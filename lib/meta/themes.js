...
Themes.setPath = function (themeObj) {
	...
	var fallback = nfs.join(nconf.get('themes_path'), themeObj.id, 'templates');

	if (themeObj.templates) {
		themePath = nfs.join(nconf.get('themes_path'), themeObj.id, themeObj.templates);
	} else if (nfs.existsSync(fallback)) {
		themePath = fallback;
	}

	nconf.set('theme_templates_path', themePath);
	nconf.set('theme_config', nfs.join(nconf.get('themes_path'), themeObj.id, 'theme.json'));
};
