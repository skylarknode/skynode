...
<head>
	...
	<title>SkyBB Web Installer</title>
...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">SkyBB</a>
			</div>
	...
	<div class="container <!-- IF success -->hide<!-- ENDIF success -->">
		<p>
			<h1>Welcome to the SkyBB Installer</h1>
			You are just a few steps away from launching your own SkyBB forum!
		</p>
		<form id="install" action="/" method="post">
			...
			<div class="general">
				...
				<div class="row input-row">
					...
					<div class="col-sm-5 help-text" data-help="This is the address that resolves to your SkyBB forum. If no port is specified, <code>4567</code> will be used."></div>
				</div>
			</div>
			<!-- END -->
			<div class="admin">
			...
			<button id="submit" type="submit" class="btn btn-lg btn-success">Install SkyBB <i class="working hide"></i></button>
		</form>
	</div>
	<!-- ENDIF !installing -->
	...
	<div id="installing" class="container">
		<p>
			<h1>Hang tight! Your SkyBB is being installed.</h1>
		</p>
	</div>
	<!-- ENDIF installing -->
	...
	<div class="container <!-- IF !success -->hide<!-- ENDIF !success -->">
		<p>
			<h1>Congratulations! Your SkyBB has been set-up.</h1>

			<button id="launch" data-url="{launchUrl}" class="btn btn-lg btn-success">Launch SkyBB <i class="working hide"></i></button>
		</p>
	</div>
