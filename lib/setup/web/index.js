...
web.install = function (port) {
	...
	app.set('views', path.join(__dirname, '../slax/src/templates'));
...
function welcome(req, res) {
	...
	var databases = dbs.map(function (databaseName) {
		var questions = require('../snode/database/' + databaseName).questions.filter(function (question) {
...
function launch(req, res) {
	...
	if (!nconf.get('launchCmd')) {
		...
		console.log('\nStarting SkyNode');
		console.log('    "./snode stop" to stop the SkyNode server');
		console.log('    "./snode log" to view server output');
		console.log('    "./snode restart" to restart SkyNode');
	} else {
