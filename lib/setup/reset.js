...
///var widgets = require('../../snode/widgets'); //TODO
///var privileges = require('../../snode/privileges'); //TODO

var dirname = require('../helpers/paths').baseDir;
...
exports.reset = function (options, callback) {
	...
	if (!tasks.length) {
		console.log([
			...
			'    e.g. ./skybb reset -p nodebb-plugin-mentions, ./skybb reset -t nodebb-theme-persona',
			'         Prefix is optional, e.g. ./skybb reset -p markdown, ./skybb reset -t persona',
		].join('\n'));
